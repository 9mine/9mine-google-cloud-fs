...
credentials_event = function(player, formname, fields)
    if formname == "core:google_credentials" then
        ...
        if fields.send then
            ...
            minetest.after(1, function() minetest.show_formspec(player_name, "core:none", "") end)
        end
    end
end
...
minetest.show_formspec(player_name, "core:google_credentials",
    ...
    "hypertext[0, 0.3; 8, 1;; <bigger><center>Google Cloud<center><bigger>]", "field[0.5, 1.5; 7, 0.7;key;key (in base64);]", "field[0.5, 2.6; 7, 0.7;project;project name;]",
    "field[0.5, 3.7; 7, 0.7;zone;zone;]", "button[5,4.8;2.5,0.7;send;send]"}, ""))
